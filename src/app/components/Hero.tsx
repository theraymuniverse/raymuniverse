  ...
  return (
    <section className="relative text-center pt-28 lg:pt-32 pb-8 md:pb-10 lg:pb-20 bg-black" id='hero'>
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bricolage font-black mb-6 md:mb-6 pt-28 leading-tight md:leading-tight text-white">
          <span 
        ...
        <div className="flex flex-col gap-3 sm:gap-4 md:flex-row md:gap-6 lg:gap-8 justify-center items-center">
          <p className="w-full md:w-auto bg-gray-800 px-3 sm:px-4 md:px-6 py-2 rounded-md border border-gray-700 text-xs sm:text-sm md:text-base text-gray-100 hover:bg-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-gray-600">
